...
a = np.array([[random.randrange(10) for i in range(5)],[random.randrange(10) for i in range(5)]])
...
num02 = num01*2
num03 = num01**3
#broadcasting creates a scaleaur value and applies it to every element i.e [1,2,3]*3 = [3,6,9]
num01 += 10
num04 = num01*num02
num05 = num01 > 13
num06 = num03 > num01
...
# calculate average on all rows for each row
